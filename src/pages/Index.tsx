        ...
        <div className="text-left max-w-4xl mt-20 px-4">
          <p className="text-neutral-1100 text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight">
            ...
            <LinkPreview 
              ...
              className="font-bold text-[#2E6BE6] inline"
            >
              OptimoRoute
            </LinkPreview>
            . I created{" "}
            <LinkPreview 
              ...
              className="font-bold text-[#99CAFC] inline"
              isStatic={true}
            ...
            <LinkPreview 
              url="https://www.behance.net" 
              className="font-bold text-[#F45D5D] inline"
              isStatic={true}
            ...
            <LinkPreview 
              ...
              className="font-bold text-[#BF3F57] inline"
            >
              &lt;real portfolio&gt;
            </LinkPreview>{" "}
          ...
          <p className="text-neutral-1100 text-xl mt-6">
            ...
            <LinkPreview 
              url="https://www.linkedin.com/in/tnad/" 
              className="font-bold text-[#0A66C2] inline"
              isStatic={true}
            ...
            <LinkPreview 
              ...
              className="font-bold text-[#34A853] inline"
              isStatic={true}
              imageSrc="/lovable-uploads/29dea49a-e64b-46af-92f2-6e130e572eca.png"
            >
              Email
