...
const Index = () => {
  return <div className="min-h-screen flex justify-center items-center bg-white p-4">
      <div className="text-left max-w-8xl px-[80px]">
        <p className="text-neutral-1100 text-8xl lg:text-7xl md:text-5xl">
          Hey, I'm{" "}
          ...
          <LinkPreview url="https://www.behance.net" className="font-bold text-[#BF3F57]">
            &lt;real portfolio&gt;
          </LinkPreview>{" "}
        ...
        <p className="text-neutral-1100 text-xl mt-6">
          This is my{" "}
          <LinkPreview url="https://www.linkedin.com/in/tnad/" className="font-bold text-[#0A66C2]">
            LinkedIn
          </LinkPreview>
          , and this is my{" "}
          <LinkPreview url="mailto:hi@tnad.xyz" className="font-bold text-[#34A853]">
            Email
          </LinkPreview>
          .
        </p>
