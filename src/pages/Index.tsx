      ...
      <div className="text-left max-w-6xl px-[80px]">
        <p className="text-neutral-1100 text-6xl lg:text-7xl md:text-5xl leading-relaxed">
          ...
          <LinkPreview 
            ...
            className="font-bold text-7xl lg:text-8xl md:text-6xl"
            isStatic={true}
          ...
          <LinkPreview url="https://optimoroute.com" className="font-bold text-7xl lg:text-8xl md:text-6xl text-[#2E6BE6]">
            OptimoRoute
          </LinkPreview>
          . I created{" "}
          <LinkPreview 
            url="https://www.behance.net" 
            className="font-bold text-7xl lg:text-8xl md:text-6xl text-[#99CAFC]"
            isStatic={true}
          ...
          <LinkPreview 
            url="https://www.behance.net" 
            className="font-bold text-7xl lg:text-8xl md:text-6xl text-[#F45D5D]"
            isStatic={true}
          ...
          <LinkPreview 
            ...
            className="font-bold text-7xl lg:text-8xl md:text-6xl text-[#BF3F57]"
          >
            &lt;real portfolio&gt;
          </LinkPreview>{" "}
        ...
        <p className="text-neutral-1100 text-xl mt-6 leading-relaxed">
          ...
          <LinkPreview 
            url="https://www.linkedin.com/in/tnad/" 
            className="font-bold text-2xl text-[#0A66C2]"
            isStatic={true}
          ...
          <LinkPreview 
            ...
            className="font-bold text-2xl text-[#34A853]"
            isStatic={true}
            imageSrc="/lovable-uploads/29dea49a-e64b-46af-92f2-6e130e572eca.png"
          >
            Email
